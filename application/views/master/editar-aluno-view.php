...
<form method="POST">
	<div class="form-group">
		<label>Nome</label>
		<?php $value = ( set_value('nome') ) ? set_value('nome') : $aluno->nome; ?>
		<input type="text" class="form-control" name="nome" placeholder="Digite o seu nome..." value="<?php echo $value; ?>">
	</div>
	<div class="form-group">
		<label>Sexo:</label>
		<?php $value = ( set_value('sexo') ) ? set_value('sexo') : $aluno->sexo; ?>
	...
	<div class="form-group">
		...
		<?php $value = ( set_value('matricula') ) ? set_value('matricula') : $aluno->matricula; ?>
		<input type="text" class="form-control" name="matricula" placeholder="Digite a sua matrícula..." value="<?php echo $value; ?>">
	</div>
	<div class="form-group">
		<label>E-mail</label>
		<?php $value = ( set_value('email') ) ? set_value('email') : $aluno->email; ?>
	...
	<input type="hidden" class="form-control" name="id" value="<?php echo $aluno->id; ?>">
	<input type="hidden" class="form-control" name="perfil" value="<?php echo $aluno->perfil; ?>">
