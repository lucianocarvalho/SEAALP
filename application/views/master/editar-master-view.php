...
<form method="POST">
	<div class="form-group">
		<label>Nome</label>
		<?php $value = ( set_value('nome') ) ? set_value('nome') : $master->nome; ?>
		<input type="text" class="form-control" name="nome" placeholder="Digite o seu nome..." value="<?php echo $value; ?>">
	</div>
	<div class="form-group">
		<label>Sexo:</label>
		<?php $value = ( set_value('sexo') ) ? set_value('sexo') : $master->sexo; ?>
	...
	<div class="form-group">
		<label>E-mail</label>
		<?php $value = ( set_value('email') ) ? set_value('email') : $master->email; ?>
	...
	<input type="hidden" class="form-control" name="id" value="<?php echo $master->id; ?>">
	<input type="hidden" class="form-control" name="perfil" value="<?php echo $master->perfil; ?>">
